...
| Model | Train Macro F1 | Validation Macro F1 | Notes |
| --- | --- | --- | --- |
| [TfidfLogisticRegression](../src/text_classification/models/tfidf_logistic_regression.py) | 0.809 | 0.662 | 🎖 All defaults |
| [TfidfLogisticRegression](../src/text_classification/models/tfidf_logistic_regression.py) | 0.814 | 0.658 | +stop_words="english" |
...
| Model | Train Macro F1 | Validation Macro F1 | Notes |
| --- | --- | --- | --- |
| [TfidfLogisticRegression](../src/text_classification/models/tfidf_logistic_regression.py) | 0.424 | 0.409 | +C=0.1 |
| [TfidfLogisticRegression](../src/text_classification/models/tfidf_logistic_regression.py) | 0.796 | 0.658 | +C=0.9 |
| [TfidfLogisticRegression](../src/text_classification/models/tfidf_logistic_regression.py) | 0.716 | 0.615 | +C=0.5 |
...
| Model | Train Macro F1 | Validation Macro F1 | Notes |
| --- | --- | --- | --- |
| [TfidfLogisticRegression](../src/text_classification/models/tfidf_logistic_regression.py) | 0.788 | 0.688 | 🎖 +max_features=10000 |
| [TfidfLogisticRegression](../src/text_classification/models/tfidf_logistic_regression.py) | 0.756 | 0.658 | +max_features=5000 |
...
| Model | Train Macro F1 | Validation Macro F1 | Notes |
| --- | --- | --- | --- |
| [TfidfLogisticRegression](../src/text_classification/models/tfidf_logistic_regression.py) | 0.788 | 0.672 | +max_features=10000 +stop_words="english" |
...
* ❓ What is the model learning? Are there any insights about the training dataset?
    * 📄 See [Interpreting `TfidfLogisticRegression` Model](../notebooks/interpreting_tfidf_logistic_regression_model.ipynb). [Source](../notebooks/interpreting_tfidf_logistic_regression_model.py)
* ❓ What's the model's performance for each category?
* ❓ What are some example samples that the model is getting wrong?
    * 📄 See [Evaluating `TfidfLogisticRegression` Model](../notebooks/evaluating_tfidf_logistic_regression_model.ipynb). [Source](../notebooks/evaluating_tfidf_logistic_regression_model.py)
...
| Model | Train Macro F1 | Validation Macro F1 | Notes |
| --- | --- | --- | --- |
| [SentenceTransformerLogisticRegression](../src/text_classification/models/sentence_transformer_logistic_regression.py) | 0.742 | 0.720 | 🎖 |
...
| Model | Train Macro F1 | Validation Macro F1 | Notes |
| --- | --- | --- | --- |
| [SentenceTransformerLogisticRegression](../src/text_classification/models/sentence_transformer_logistic_regression.py) | 0.742 | 0.718 | 🎖 |
...
| Model | Train Macro F1 | Validation Macro F1 | Notes |
| --- | --- | --- | --- |
| [SentenceTransformerNN](../src/text_classification/models/sentence_transformer_logistic_regression.py) | 0.731 | 0.733 | 🎖 |
...
* 🪨 Will choose `SentenceTransformerLogisticRegression` as the model to 'deploy'.
